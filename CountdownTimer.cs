...
public class CountdownTimer : MonoBehaviour
{
    ...
    void Update()
    {
        if (contadorActivo)
        {
            ...
            tiempoRestante = 600f - tiempoTranscurrido; // Actualizamos el tiempo restante
    ...
    void CambiarEscena()
    {
        SceneManager.LoadScene("Perdiste"); // Reemplaza "NombreDeTuEscena" por el nombre de la escena a la que quieres cambiar
    }
}
