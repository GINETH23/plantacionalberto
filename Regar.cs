...
public class Regar : MonoBehaviour
{
    ...
    public Transform[] positions; // Lista de posiciones donde se moverá el trigger y la luz
    ...
    void Update()
    {
        if (isInsideTrigger && Input.GetKeyDown(KeyCode.E))
        {
            ...
            // Mueve el trigger y la luz a la siguiente posición
            ...
            // Verifica si se han completado 15 puntos y cambia de escena si es así
            if (score >= 6)
            {
